...
func Insert(t *testing.T, repo grimoire.Repo) {
	...
	for _, test := range tests {
		...
		statement, _ := sql.NewBuilder("?", false, false).Insert(test.query.Collection, ch.Changes())
...
func InsertSet(t *testing.T, repo grimoire.Repo) {
	...
	for _, test := range tests {
		statement, _ := sql.NewBuilder("?", false, false).Insert(test.query.Collection, test.query.Changes)
